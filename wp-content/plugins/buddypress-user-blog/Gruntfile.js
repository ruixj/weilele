...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'assets/css/bp-user-blog.min.css': 'assets/css/bp-user-blog.css',
                }
            }
        },
        /*
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'bower_components/medium-editor-insert-plugin/dist/js/medium-editor-insert-plugin.min.js': [ 'bower_components/medium-editor-insert-plugin/dist/js/medium-editor-insert-plugin.js' ],
                    'assets/js/bp-user-blog.min.js': [ 'assets/js/bp-user-blog.js' ]
                }
            }
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'bp-user-blog', 'buddypress', 'bbpress', 'buddypress-inbox', 'buddyboss-media', 'buddyboss-welcome-experience' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'bp-user-blog.pot', // Name of the POT file.
