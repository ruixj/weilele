...
if ( ! class_exists( 'BuddyBoss_SAP_Blog' ) ):
	...
	class BuddyBoss_SAP_Blog {
		...
		public function setup() {
			...
			add_action( 'bp_setup_admin_bar', array( $this, 'sap_setup_admin_bar' ), 20 );
        ...
        public function sap_blog_filter(){
            ...
            if ( ($bp->current_action == 'blog' 
			      || $bp->current_action == 'drafts' 
			      || $bp->current_action == 'pending' 
			      || $bp->current_action == 'bookmarks'
			     ) 
				 && (bp_displayed_user_id() == bp_loggedin_user_id() )
				 && $create_new_post_page 
			) {
