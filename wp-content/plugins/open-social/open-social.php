...
function open_init() {
	...
	if (isset($_GET['connect'])) {
		...
		if ($_GET['action'] == 'login') {
			...
			if((!isset($_GET['code'])&& !isset($_GET['token'])) || isset($_GET['error']) || isset($_GET['error_code']) || isset($_GET['error_description'])){
...
class BASE_CLASS
{
	...
	function save_extra_data($newuser)
	{
