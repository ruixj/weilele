...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'assets/css/buddypress-global-search.min.css': [ 'assets/css/buddypress-global-search.css' ]
                }
            }
        },
        /*
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/buddypress-global-search.min.js': [ 'assets/js/buddypress-global-search.js' ],
                }
            },
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddypress-global-search', 'buddypress', 'bbpress', 'woothemes-sensei', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddypress-global-search.pot', // Name of the POT file.
