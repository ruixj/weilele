 ...
 * @since 2.0.0
 */
class BP_XProfile_Field_Type_MobileTel extends BP_XProfile_Field_Type {
	...
	public function __construct() {
		...
		$this->name     = _x( '手机号', 'xprofile field type', 'buddypress' );
		 ...
		 */
		do_action( 'bp_xprofile_field_type_mobiletel', $this );
	}
