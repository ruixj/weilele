	                ...
	                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?> role="article">
                        <div class="singlebox our_authors">
							    ...
							    <section class="entry-content clearfix">
							        <?php the_content(); ?>
									    <?php $jovial_guestauthors = get_users('orderby=post_count&role=contributor');
                                        if(isset($jovial_guestauthors) && !empty($jovial_guestauthors)){ 
				    foreach($jovial_guestauthors as $author){
